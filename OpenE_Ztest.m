function [Good_Z_loc] = OpenE_Ztest(foldername,plotswitch,Thr_max)
...
%	foldername = input('Enter the impdedance folder name to process: ','s'); 
    %folder_path = sprintf('/home/jaejin/ArmyProject/Abu/Neural/%s',foldername);
...
%                    191 193 157 155 151 133 148 134 160 186 172 189 167 177 223 255];
 ...
 %% Calculating the yield
	...
	if plotswitch == 1;
		...
		set(gcf,'Position',[currPos(1),currPos(2),700,600]);
	end
end
